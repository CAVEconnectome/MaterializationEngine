...
class VersionResource(Resource):
    ...
    def post(self, aligned_volume_name: str):
        ...
        base = Base
        base.metadata.bind = db_client.database.engine
    ...
    def get(self, aligned_volume_name: str, version: int, tablename: str):
        ...
        try:
            annotation_table = Table(
                ...
                metadata,
                autoload=True,
                autoload_with=db_client.database.engine,
            )
...
class CreateVirtualPublicVersionResource(Resource):
    ...
    def post(self):
        ...
        with db_client.database.session_scope() as session:
            ...
            virtual_datastack_name = (
                f"{virtual_version_name}_v{analysis_version.version}"
            )
